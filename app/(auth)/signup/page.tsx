...
const Signup = async() => {
    ...
    return (
        <div className='w-full flex flex-col items-center mt-[40px]'>
            ...
            <div style={{
            ...
            }} className='mt-[20px] bg-dark1 w-full md:w-[500px] flex flex-col items-center gap-[20px] py-[40px] px-[20px] rounded-lg shadow-lg shadow-yellow1 text-center '>
                ...
                <div className='w-[80%] flex flex-col gap-[20px]'>
                    <div className='flex items-center justify-center gap-[10px] bg-white p-[10px] rounded-[4px]'>
                        <FcGoogle />
