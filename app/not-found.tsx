    ...
    return (
        <div className='w-full min-h-[75vh] max-h-[100vh] flex flex-col justify-center items-center'>
            ...
            <div className='w-full flex flex-col items-center gap-[20px] p-[30px]'>
                <h2 className='text-4xl font-bold'><span className='border-r-2 border-yellow1 px-[20px]'>404</span><span className='px-[20px] '>Not Found</span></h2>
                <p>Could not find requested resource</p>
                <Link href="/" className='bg-yellow1 px-[20px] py-[8px] font-semibold rounded-[4px]'>Return Home</Link>
            </div>
        </div>
    )
}